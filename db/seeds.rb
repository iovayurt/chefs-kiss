...
chef2 = { user: user2, first_name: "Mahmut", last_name: "Usta", speciality: "Turkish food", rating: 4, price: "200 TL"}
chef3 = { user: user2, first_name: "Lea", last_name: "Monet", speciality: "French food", rating: 4, price: "800 TL"}
...
chef6 = { user: user3, first_name: "Chen", last_name: "Zhao", speciality: "Chinese food", rating: 4, price: "350 TL"}
chef7 = { user: user, first_name: "Marco", last_name: "Giovanni", speciality: "Italian food", rating: 3, price: "150 TL"}
chef8 = { user: user3, first_name: "Somer", last_name: "Sivri", speciality: "Turkish food", rating: 5, price: "600 TL"}
